  ...
  void run_tutorial()
{
    ...
    std::cout << "called tutorial" << std::endl;
  /**
  ...
  **/
  ...
  std::cout << "initialized dense" << std::endl;
  /**
  ...
  std::cout << "initialized sparse" << std::endl;
...
std::cout << "about to create vcl" << std::endl;
  /**
  ...
  std::cout << "about to create matrix" << std::endl;

  viennacl::matrix<ScalarType> vcl_densemat(6, 5);

  std::cout << "about to create compressed" << std::endl;
